...
public class Tasks3Controller {
    ...
    private final Tasks3Service service; //No se inicializa porque estamos usando spring, el se encarga de crear el componente

    //Constructor para inicializar el servicio
    public Tasks3Controller( @Autowired Tasks3Service service){// Autowired le dice a Spring que se encargue de crear el objeto service y pasarlo al controller
